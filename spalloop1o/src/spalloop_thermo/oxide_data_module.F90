MODULE OXIDE_DATA_MODULE
  ...
  ! micron2m - to convert oxide thickness to m from microns
  real  :: oxide_thick_uf, const_energy_uf, micron2m
  ...
  integer :: n_it_max
  real    :: error_temp_max, error_temp_norm, error_oxide_thick_ratio
